...
namespace Megaphone.WebApi
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var uri = Cluster.Bootstrap(new WebApiProvider(), new ConsulProvider(), "values", "v1", tags: new[] { "provider", "providers", "providers2" }, host: "localhost", port: 5001, useHttps: false, selfRegisterTimer: true, selfRegisterTimerInterval: 10000);
